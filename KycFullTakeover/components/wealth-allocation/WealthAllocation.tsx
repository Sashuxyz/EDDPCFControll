// MIRROR OF WealthAllocationControl/components/WealthAllocationControl.tsx
...
import { headroomFor, formatCHF, totalAllocated, parseCHFInput } from './allocationLogic';
import { AllocationBar } from './AllocationBar';
import { AssetRow } from './AssetRow';
import { UnallocatedRow } from './UnallocatedRow';
import { containerStyles, inputStyles, tableStyles, summaryStyles } from './tokens';

interface WealthAllocationProps {
...
export const WealthAllocation: React.FC<WealthAllocationProps> = ({
  state,
  disabled,
  onTotalWealthChange,
  onSliderChange,
