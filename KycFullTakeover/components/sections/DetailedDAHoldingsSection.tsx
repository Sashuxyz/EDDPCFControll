...
function rowToCardConfig(
  ...
  const details: ItemizedCardDetail[] = [
    { kind: 'lookup',   label: 'Asset',                    value: row.syg_digitalassetid, entityTypes: ['syg_digitalassetcurrency'], onChange: u('syg_digitalassetid') },
    ...
    { kind: 'lookup',   label: 'Acquiring year',           value: row.syg_acquiringyear, entityTypes: ['syg_year'], onChange: u('syg_acquiringyear') },
